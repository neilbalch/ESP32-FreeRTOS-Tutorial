...
namespace Part9 {
static const uint16_t timer_prescaler =
    80;  // Clock ticks at 80 MHz / 80 = 1 MHz
static const uint64_t timer_max_count =
    1e6;  // 1e7 max count means that the timer will reset after 1 second

static hw_timer_t *timer = NULL;

// IRAM_ATTR forces the ISR to live in internal RAM and not the flash for faster
// access
...
void setup() {
  ...
  timer =
      timerBegin(0 /* timer number */, timer_prescaler, true /* countUp? */);
